package by.bsuir.ceres.validation;
...
public class UserValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        User user = (User) o;
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "user.mail", "NotEmpty");

        if (userService.findByEmail(user.getMail()) != null) {
            errors.rejectValue("user.mail", "Duplicate.userForm.email");
        }
